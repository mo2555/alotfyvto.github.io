...
type VideoSourceParams = VideoParams | MediaStreamConstraints | MediaStream | string;
...
type ImageSource = ImageBitmap | ImageData | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | Uint8Array;
/**
 * Image texture
 *
...
export { CanvasMode, CanvasParams, CanvasRenderer, Engine, EngineParams, EventEmitterT, ImageBuffer, ImageBytes, ImageInput, ImageTexture, Plugin, PluginRenderer, ProcParams, Processor, Recorder, Renderer, ResponsiveCanvas, ScenePlugin, SceneRenderer, ShaderPlugin, ShaderProgram, ShaderRenderer, Size, Snapshoter, Streamer, UniRecorder, UniformType, VideoCapture, VideoParams, VideoPlugin, VideoRenderer, VideoSource, VideoSourceParams };
