 ...
 */
declare class BabylonRenderer<ResultT extends {} = {}> extends SceneRenderer<ResultT, Scene> {
    /** Rendering engine */
 ...
 * @typeParam ResultT - Type of processing results
 */
declare class BabylonPlugin<ResultT extends {} = {}> extends ScenePlugin<ResultT, Scene> {
}
/**
 ...
 * @typeParam ResultT - Type of processing results
 */
declare class BabylonUniRenderer<ResultT extends {} = {}> extends SceneRenderer<ResultT, Scene> {
    /** Rendering engine */
    protected renderer: Engine;
    /** Video layer */
...
declare class HeadTrackPlugin extends BabylonPlugin<FaceResult> {
     ...
     */
    constructor(node: TransformNode, shapeScale?: boolean);
    /**
...
declare class FaceTrackPlugin extends BabylonPlugin<FaceResult> {
     ...
     * @param shapeScale - Tune scale according to shape of the face
     */
    constructor(node: TransformNode, facePoint?: number, shapeScale?: boolean);
    /**
...
declare class FaceMaskPlugin extends BabylonPlugin<FaceResult> {
     ...
     */
    constructor(mesh?: Mesh | undefined);
    /**
     * Initialize plugin
     *
...
type SkeletonTransforms = SkeletonMap<BoneTransform>;
/** Skeleton - bones of the rig */
type SkeletonNodes = SkeletonMap<TransformNode>;
/**
...
declare class PoseAlignPlugin extends PosePlugin {
    protected node?: TransformNode | undefined;
     ...
     */
    constructor(node?: TransformNode | undefined, tune?: PoseTuneParams);
    /**
     * Initialize plugin
     *
     ...
     * @virtual
     */
    protected alignBone(transform: BoneTransform, bone: TransformNode, scale?: boolean): void;
}
...
declare class PoseOutfitPlugin extends PoseAlignPlugin {
     ...
     * @param tune - Fine-tuning parameters
     */
    constructor(node?: TransformNode, outfit?: OutfitParams | undefined, tune?: PoseTuneParams);
    /**
     * Set/attach a scene node
     *
     ...
     * @override
     */
    setNode(mesh?: TransformNode): void;
    /**
     ...
     * @returns Promise resolving when initialization is finished
     */
    setOutfit(node?: TransformNode, outfit?: OutfitParams): void;
}
...
declare class PoseTwinPlugin extends PoseAlignPlugin {
    protected translation?: Vector3 | undefined;
    protected rotation?: Quaternion | undefined;
     ...
     * @param tune - Fine-tuning parameters
     */
    constructor(node?: TransformNode, translation?: Vector3 | undefined, rotation?: Quaternion | undefined, scale?: number | undefined, tune?: PoseTuneParams);
    /**
     * Update skeleton of the scene node
     *
     ...
     * @override
     */
    protected alignBone(transform: BoneTransform, bone: TransformNode): void;
}
...
declare class BodyPatchPlugin extends ShaderPlugin<PoseResult> {
     ...
     * @override
     */
    process(result: PoseResult, input: WebGLTexture): Promise<boolean>;
}
...
declare class BodypartPatchPlugin extends ShaderPlugin<PoseResult> {
    ...
    protected partsTarget?: RenderTargetTexture;
    /** Skeletons of skinned meshes */
    protected partsSkeletons: Skeleton[];
    /** Material of "patch" parts */
    protected patchMaterial?: StandardMaterial;
    /** Material of "keep" parts */
    protected keepMaterial?: StandardMaterial;
    /**
     * Constructor
     *
     ...
     */
    constructor(patchParts?: AbstractMesh[], keepParts?: AbstractMesh[]);
    /**
     ...
     * @param keepParts - Meshes defining "keep" regions
     */
    setParts(patchParts?: AbstractMesh[], keepParts?: AbstractMesh[]): void;
    /**
     * Initialize plugin
     *
     * Initializes resources required for shader effect.
...
declare class OccluderPlugin extends BabylonPlugin<any> {
     ...
     */
    constructor(node: TransformNode, renderOrder?: number);
    /**
     * Initialize plugin
     *
 ...
 */
declare class OccluderMaterial extends PBRMaterial {
    /**
     * Constructor
     *
